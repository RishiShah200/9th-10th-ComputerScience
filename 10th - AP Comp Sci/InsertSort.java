...
for (int i = 1; i < a.length; i++ ) { // 1. START OFF AT 1
    ...
    int j = i;	// 2. VALUE NEEDED FOR INNER LOOP SET EQUAL TO VALUE OF OUTER LOOP
				// KEEPS TRACK OF INDEX OF RIGHT MOST VALUE IN ARRAY WE ARE CHECKING DURING THAT ITERATION OF OUTER LOOP.
